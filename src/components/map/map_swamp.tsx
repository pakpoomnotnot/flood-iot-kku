...
const LAV_DATA: Record<string, LavInfo> = {
  Lake_02: {
    name_th: "บึงทุ่งสร้าง", name_en: "Bueng Thung Sang",
  ...
  Lake_06: {
    name_th: "หนองเลิงเปือย", name_en: "Nong Loeng Phuai",
...
const STATION_TO_LAKE: Record<string, string> = {
  "PW01": "Lake_03",  // บึงแก่นนคร      → Lake_03
  "PW02": "Lake_02",  // บึงทุ่งสร้าง    → Lake_02
  "PW03": "Lake_01",  // สะพานบ้านทุ่งเศรษฐี → Lake_01 (ไม่มี LAV)
  "PW04": "Lake_04",  // คุ้มสีฐาน มข.   → Lake_04 (ไม่มี LAV)
  "PW05": "Lake_05",  // บึงหนองโคตร     → Lake_05
  "PW06": "Lake_06",  // หนองเลิงเปือย   → Lake_06
};
